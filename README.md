...
Longitudinal Survey of Adolescent Health (n ¼ 2193), I use a stochastic actor oriented model to
estimate the effect of peer influence on inattention, controlling for alternative network and behavioral
causes. Results indicate that respondents have a strong likelihood to modify their self-reports of inattention,
